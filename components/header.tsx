...
export default function Header({ onMenuClick, totalEarnings}: HeaderProps){
    ...
    useEffect(()=>{
        ...
        return () =>{
            removeEventListener('balanceUpdate', handleBalanceUpdate as EventListener)
        }
    },[userInfo])
    ...
    const logout = async () => {
        if (!web3Auth) {
            console.log('Web3Auth is not initialised')
            return; 
        }
        try {
            ...
            <div className='flex items-center justify-between px-4 py-2'>
                <div className='flex items-center'>
                    ...
                    <Link href="/" className='flex items-center'>
                        ...
                        <span className='font-bold text-base md:text-lg text-gray-800'>EcoScore</span>
